...
void ge_sta(unsigned int Son[][spe_num + 1], unsigned int Be[][spe_num + 2])
{
...
void ge_dy(unsigned int Son[][spe_num + 1], unsigned int Be[][spe_num + 2])
{
#pragma omp parallel  num_threads(NUM_THREADS)
...
void ge_gui(unsigned int Son[][spe_num + 1], unsigned int Be[][spe_num + 2])
{
#pragma omp parallel  num_threads(NUM_THREADS)
...
void avx_sta(unsigned int Son[][spe_num + 1], unsigned int Be[][spe_num + 2])
{
    __m256 bik1, son1, vres1;
#pragma omp parallel  num_threads(NUM_THREADS),private(bik1, son1, vres1)
#pragma omp for schedule(static)
    for (int i = 0; i < b_num; i++)
    {
        while (Be[i][spe_num + 1] == 0)
...
void avx_dy(unsigned int Son[][spe_num + 1], unsigned int Be[][spe_num + 2])
{
    __m256 bik1, son1, vres1;
#pragma omp parallel  num_threads(NUM_THREADS),private(bik1, son1, vres1)
#pragma omp for schedule(dynamic)
...
void avx_gui(unsigned int Son[][spe_num + 1], unsigned int Be[][spe_num + 2])
{
    __m256 bik1, son1, vres1;
#pragma omp parallel  num_threads(NUM_THREADS),private(bik1, son1, vres1)
#pragma omp for schedule(guided)
